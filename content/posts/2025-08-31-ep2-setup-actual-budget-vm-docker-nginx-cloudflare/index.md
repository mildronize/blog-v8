...
1. เรา clone หรือโหลด template โปรเจกต์จาก GitHub มาก่อน (บทความนี้มี repo ตัวอย่างให้)
...
```
[ User ] --HTTPS--> [ Cloudflare Proxy ] --HTTPS (Origin Cert)--> [ Nginx on VM ] --> [ Actual Budget Container ]
```
