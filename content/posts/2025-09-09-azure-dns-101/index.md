...
เข้าใจแล้วครับ 🙌 งั้นผมจะเพิ่มเนื้อหาตรง **ก่อนหัวข้อ "บทเรียนที่ได้"** ให้เล่า flow ที่คุณลองใช้ `nslookup` แล้ว validate domain กับ Azure Container App ได้สำเร็จเลยครับ
...
โอเคครับ 🙌 ผมเขียน Section สรุป Command Line สำหรับตรวจสอบ DNS ให้ครบ พร้อมแทรกอธิบาย **Non-authoritative answer** ไว้ในนี้เลย จะได้ต่อเนื่องและเข้าใจง่าย
